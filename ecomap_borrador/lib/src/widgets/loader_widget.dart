...
class _LoaderState extends State<Loader> with SingleTickerProviderStateMixin {
  ...
  void initState() { 
    ...
    controller.addListener((){
      setState(() {
        if(controller.value>=0.75 && controller.value<=1.0)radius=animation_radius_in.value*initialRadius;
        else if(controller.value>=0.0 && controller.value<=0.25)radius=animation_radius_out.value*initialRadius;
      });
    });
